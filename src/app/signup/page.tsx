    ...
    return (
      <div style={{ minHeight: "100vh", background: bg, display: "flex", alignItems: "center", justifyContent: "center", padding: "0 1rem" }}>
        <div style={{ textAlign: "center", maxWidth: 380 }}>
          ...
          <h2 style={{ fontFamily: "Georgia, serif", fontSize: 24, fontWeight: 700, color: textPrimary, marginBottom: 8 }}>Check your email</h2>
          <p style={{ color: textSecondary, fontSize: 14 }}>We sent a confirmation link to <strong>{email}</strong>. Click it to activate your account.</p>
          <Link href="/login" style={{ display: "inline-block", marginTop: 24, fontSize: 14, color: "#C9956E", textDecoration: "none" }}>Back to sign in</Link>
        </div>
      </div>
    );
  }
    ...
    <div style={{ minHeight: "100vh", background: bg, display: "flex", alignItems: "center", justifyContent: "center", padding: "0 1rem", transition: "background 0.2s" }}>
      ...
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        <div style={{ background: card, borderRadius: 16, border: `1px solid ${border}`, padding: 32, boxShadow: "0 2px 12px rgba(0,0,0,0.08)" }}>
          <button onClick={handleGoogle} style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "center", gap: 12, padding: "12px 0", border: `1px solid ${inputBorder}`, borderRadius: 8, fontSize: 14, fontWeight: 500, color: textPrimary, background: inputBg, cursor: "pointer", marginBottom: 24 }}>
          ...
          <form onSubmit={handleSignup} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div>
              <label style={{ display: "block", fontSize: 14, fontWeight: 500, color: textPrimary, marginBottom: 4 }}>Your name</label>
              <input type="text" value={name} onChange={e => setName(e.target.value)} required placeholder="Alex & Sam"
          ...
          <p style={{ textAlign: "center", fontSize: 14, color: textSecondary, marginTop: 24, marginBottom: 0 }}>
            ...
            <Link href="/login" style={{ color: "#C9956E", fontWeight: 500, textDecoration: "none" }}>Sign in</Link>
          </p>
        </div>
      </div>
    </div>
